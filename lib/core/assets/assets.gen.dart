...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/tower-comp.jpg
  AssetGenImage get towerComp =>
      const AssetGenImage('assets/images/tower-comp.jpg');

  /// File path: assets/images/tree.jpg
  AssetGenImage get tree => const AssetGenImage('assets/images/tree.jpg');

  /// List of all assets
  List<AssetGenImage> get values =>
      [bgHome, failed, lihatLokasi, logo, map, success, towerComp, tree];
}

class $AssetsLottieGen {
  const $AssetsLottieGen();

  /// File path: assets/lottie/circle.json
  LottieGenImage get circle =>
      const LottieGenImage('assets/lottie/circle.json');
  ...
  /// List of all assets
  List<LottieGenImage> get values => [circle, loading, splash];
}
